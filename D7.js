...
function concatenateStrings(str1, str2) {
  ...
  const result = firstTwo.toUpperCase() + lastThree.toLowerCase();

  console.log(result);
}

concatenateStrings("hello", "world");
concatenateStrings("hello", "epicoders");
...
console.log(incrementArrayValues(numbers3, 2));
